...
public class CustomerController implements CustomerApi {
    ...
    public CustomerVo create(@ApiParam("创建客户实体") @RequestBody CustomerCreateVo customerCreateVo) {
        return null;
    }
    ...
    public List<CustomerVo> search(@ApiParam("客户名称") @RequestParam("customer_name") String customerName) {
        return null;
    }
    ...
    public BatchResults delete(@ApiParam("多个客户id") @RequestParam("customer_ids") List<Long> customerIds) {
        return null;
    }
